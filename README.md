...
* `features`: Additional (emulated) hardware features. Currently only `'ulaplus'` is supported, and the setting defaults to `['ulaplus']`. To _disable_ ULAplus functionality, set to `[]`.
